...
public class QrCodeService {
    ...
    public byte[] generateStandardQr(String data, int width, int height) {
        return procesarImagenQr(data, COLOR_FRENTE_ESTANDAR, COLOR_FONDO_ESTANDAR);
    }
    ...
    public byte[] generarQrPremium(QrGenerateRequest request, String usuarioId) {
        ...
        return procesarImagenQr(contenidoFinal, colorFrente, colorFondo);
    }

    private byte[] procesarImagenQr(String data, String colorFrenteHex, String colorFondoHex) {
        try {
